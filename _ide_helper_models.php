 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill findSimilarSlugs(string $attribute, array $config, string $slug)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill query()
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill whereSlug($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BvSkill withUniqueSlugConstraints(\Illuminate\Database\Eloquent\Model $model, string $attribute, array $config, string $slug)
 */
	class BvSkill extends \Eloquent {}
}
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\CandidateBvSkill> $bvskills
 * @property-read int|null $bvskills_count
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Candidate whereChildren($value)
 ...
 * @property int $bv_skill_id
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \App\Models\BvSkill|null $bvskill
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill query()
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill whereBvSkillId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill whereCandidateId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateBvSkill whereUpdatedAt($value)
 */
	class CandidateBvSkill extends \Eloquent {}
}
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateEducation whereCourse($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateEducation whereInstitution($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|CandidateExperience whereJobTitle($value)
