...
class HomeController extends Controller
{
    ...
    function index(): View
    {
        ...
        return view('frontend.home.index', compact('plans', 'hero', 'jobCategories', 'countries', 'jobCount', 'popularJobCategories', 'featuredCategories', 'companies',  'blogs'));//'whyChooseUs', 'learnMore', 'counter', 'locations', 'reviews',
    }
