                ...
                <div class="swiper-wrapper pt-5">
                    <div class="swiper-slide">
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-1.png') }}"></div>
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-2.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-3.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-4.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-5.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-6.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-7.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-8.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-9.png') }}"></div>
                                    <div class="text-info-right">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/brands/brand-10.png') }}"></div>
                                    <div class="text-info-right">
                                        <h4>Honda</h4><img alt="joblist"
                                            src="{{ asset('frontend/assets/imgs/template/icons/star.svg') }}"><img
                                            alt="joblist" src="assets/imgs/template/icons/star.svg"><img
                                            alt="joblist" src="assets/imgs/template/icons/star.svg"><img
                                            alt="joblist" src="assets/imgs/template/icons/star.svg"><img
                                            alt="joblist" src="assets/imgs/template/icons/star.svg"><span
