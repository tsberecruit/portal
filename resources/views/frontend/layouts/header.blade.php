      ...
      <div class="main-header">
        <div class="header-left">
          <div class="header-logo"><a class="d-flex" href="index.html"><img alt="joblist"
                src="{{ asset('frontend/imgs/template/logo.png') }}"></a></div>
        </div>
        ...
        <div class="header-right">
          <div class="block-signin">
            ...
            @if (auth()->user()->role === 'company')
                <a class="btn btn-default btn-shadow ml-40 hover-up" style="width: 200px" href="{{ route('company.profile') }}">Company Dashboard</a>
    ...
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="perfect-scroll">
          ...
          <div class="site-copyright">Copyright {{ date('Y') }} &copy; joblist. <br>Developed by KellyXGlobal Tech Solutions.</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="perfect-scroll">
          ...
          <div class="site-copyright">Copyright {{ date('Y') }} &copy; joblist. <br>Developed by KellxyGlobal Tech Solutions.</div>
        </div>
      </div>
    </div>
  </div>
