                            ...
                            @forelse ($appliedJobs as $appliedJob)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <span class="badge bg-success">111</a></span>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <span class="bg-success"><a class="btn btn-border mb-20" href="{{ route('candidate.profile.track-candidate-application') }}">Track Job</a></span>
