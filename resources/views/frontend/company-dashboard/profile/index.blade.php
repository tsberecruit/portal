                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <form action="{{ route('company.profile.founding-info') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="organization_type" id="" class="form-control form-icons select-active {{ $errors->has('organization_type') ? 'is-invalid' : '' }}">
                                                <option value="">Select</option>
                                                @foreach($organziationTypes as $organizationType)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="establishment_date" type="text" class="form-controll datepicker {{ $errors->has('establishment_date') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->establishment_date }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="website" type="text" class="form-controll {{ $errors->has('website') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->website }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->email }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" type="tel" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->phone }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="country" id="" class="form-control form-icons country select-active {{ $errors->has('country') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->country }}">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="state" id="" class="form-control state form-icons select-active {{ $errors->has('state') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->state }}">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="city" id="" class="form-control city form-icons select-active {{ $errors->has('city') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->city }}">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="address" type="text" class="form-controll {{ $errors->has('address') ? 'is-invalid' : '' }}" value="{{ $companyInfo?->address }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="map_link" type="text" class="form-controll" value="{{ $companyInfo?->map_link }}">
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <form action="{{ route('company.profile.account-info') }}" method="POST"enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Username: *</label>
                                            <input type="text" name="name" class="form-controll {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ auth()->user()?->name }}">
                                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Email: *</label>
                                            <input type="text" name="email" class="form-controll {{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ auth()->user()?->email }}">
                                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                <form action="{{ route('company.profile.password-update') }}" method="POST"enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Password: *</label>
                                            <input name="password" type="password" class="form-controll {{ $errors->has('password') ? 'is-invalid' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="password_confirmation" type="password" class="form-controll {{ $errors->has('password_confirmation') ? 'is-invalid' : '' }}">
